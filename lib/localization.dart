...
const Map<String, Map<String, String>> localizedTexts = {
  ...
  "sr": {
    ...
    correctPass:"Лозинка мора да се састоји од најмање 8 карактера и мора да садржи слова и бројеве.",
    ...
    onDeg: "он",
    profileMinimalDescription:"Брзина вентилатора је мања, унутрашња температура је нижа.",
    profileMaximalDescription:"Брзина вентилатора је маxимална, унутрашња температура је виша.",
    profileOptimalDescription:"Брзина вентилатора и унутрашња температура су оптимални.",
    profileCustomDescription:"Корисник бира брзину вентилатора на основу температуре.",
    ...
    aboutCollectorText:"Наш професор је направио соларни колектор  2017. године.\n\nНаша група је добила прилику да направи контролну јединицу за управљење колектором.",
    aboutCollectorImageDescription: "Професор и колектор",
    collectorControlling: "Управљање",
    collectorControllingText:"Уградили смо један Node MCU и топлотни сензор са којим меримо температуру у реалном времену и управљамо колектором.",
    theApplication: "Апликација",
    theApplicationText:"Наш циљ је да колектор буде доступан са било које локације, зато је направљена ова апликација.",
    collectorControllingImageDescription: "Контролна јединица у кутији за слаткише",
    langHu: "Мађарски",
    langEn: "Енглески",
  ...
  "sr_Latn": {
    ...
    correctPass:"Lozinka mora da se sastoji od najmanje 8 karaktera i mora da sadrži slova i brojeve.",
    ...
    onDeg: "on",
    profileMinimalDescription:"Brzina ventilatora je manja, unutrašnja temperatura je niža.",
    profileMaximalDescription:"Brzina ventilatora je maximalna, unutrašnja temperatura je viša.",
    profileOptimalDescription:"Brzina ventilatora i unutrašnja temperatura su optimalni.",
    profileCustomDescription:"Korisnik bira brzinu ventilatora na osnovu temperature.",
    ...
    aboutCollectorText:"Naš profesor je napravio solarni kolektor  2017. godine.\n\nNaša grupa je dobila priliku da napravi kontrolnu jedinicu za upravljenje kolektorom.",
    aboutCollectorImageDescription: "Profesor i kolektor",
    collectorControlling: "Upravljanje",
    collectorControllingText:"Ugradili smo jedan Node MCU i toplotni senzor sa kojim merimo temperaturu u realnom vremenu i upravljamo kolektorom.",
    theApplication: "Aplikacija",
    theApplicationText:"Naš cilj je da kolektor bude dostupan sa bilo koje lokacije, zato je napravljena ova aplikacija.",
    collectorControllingImageDescription: "Kontrolna jedinica u kutiji za slatkiše",
    langHu: "Mađarski",
    langEn: "Engleski",
